...
import com.example.sthenos.indoor.pushups.WidePseudoPushUps;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.widepseudopushups;

public class WidePseudoPushUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WidePseudoPushUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WidePseudoPushUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(WidePseudoPushUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(WidePseudoPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(WidePseudoPushUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(WidePseudoPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(WidePseudoPushUpOutdoor.this, MainActivity.class);
                        Toast.makeText(WidePseudoPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(WidePseudoPushUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(WidePseudoPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(WidePseudoPushUpOutdoor.this, Equipment.class);
                        Toast.makeText(WidePseudoPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
