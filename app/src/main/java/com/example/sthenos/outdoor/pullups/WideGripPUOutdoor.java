...
import com.example.sthenos.indoor.pullups.WideGripPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.widegrippullups;

public class WideGripPUOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(widegrippullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Wide Grip Pull Ups");
        ...
        descText.setText("When doing the wide grip pull up make sure to stay straight and engage your entire body " +
                "and keep your hands as far apart as possible. Never sacrifice form for reps");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WideGripPUOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WideGripPUOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(WideGripPUOutdoor.this, IndoorActivity.class);
                        Toast.makeText(WideGripPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(WideGripPUOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(WideGripPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(WideGripPUOutdoor.this, MainActivity.class);
                        Toast.makeText(WideGripPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(WideGripPUOutdoor.this, MobilityActivity.class);
                        Toast.makeText(WideGripPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(WideGripPUOutdoor.this, Equipment.class);
                        Toast.makeText(WideGripPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
