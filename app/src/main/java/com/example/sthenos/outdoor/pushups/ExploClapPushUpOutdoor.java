...
import com.example.sthenos.indoor.pushups.ExplosiveClapPushUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.explosiveclappushups;

public class ExploClapPushUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(explosiveclappushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Explosive clap push-ups (Level 25)");
        ...
        descText.setText("The explosive clap push up is essentially a regular push up with clapping");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ExploClapPushUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ExploClapPushUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(ExploClapPushUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(ExploClapPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(ExploClapPushUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(ExploClapPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(ExploClapPushUpOutdoor.this, MainActivity.class);
                        Toast.makeText(ExploClapPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(ExploClapPushUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(ExploClapPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(ExploClapPushUpOutdoor.this, Equipment.class);
                        Toast.makeText(ExploClapPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
