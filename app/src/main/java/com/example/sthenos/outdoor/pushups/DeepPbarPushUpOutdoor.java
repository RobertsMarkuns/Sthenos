...
import com.example.sthenos.indoor.pushups.DeepPbarPushUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.deeppbarpushups;

public class DeepPbarPushUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(deeppbarpushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Deep P-bar push-ups (Level 15)");
        ...
        descText.setText("Get on top of parallel bars and try do go as deep as possible");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeepPbarPushUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeepPbarPushUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(DeepPbarPushUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(DeepPbarPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(DeepPbarPushUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(DeepPbarPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(DeepPbarPushUpOutdoor.this, MainActivity.class);
                        Toast.makeText(DeepPbarPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(DeepPbarPushUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(DeepPbarPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(DeepPbarPushUpOutdoor.this, Equipment.class);
                        Toast.makeText(DeepPbarPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
