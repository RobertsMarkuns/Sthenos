...
import static com.example.sthenos.R.drawable.sideplank;

public class AbsSidePlankOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(sideplank);
        ...
        muscleGroupText.setText("Shoulders, Abs");

        descText.setText("Make sure your arm  90 degrees and you should be extend your shoulders downwards and " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AbsSidePlankOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AbsSidePlankOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(AbsSidePlankOutdoor.this, IndoorActivity.class);
                        Toast.makeText(AbsSidePlankOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(AbsSidePlankOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(AbsSidePlankOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(AbsSidePlankOutdoor.this, MainActivity.class);
                        Toast.makeText(AbsSidePlankOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(AbsSidePlankOutdoor.this, MobilityActivity.class);
                        Toast.makeText(AbsSidePlankOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(AbsSidePlankOutdoor.this, Equipment.class);
                        Toast.makeText(AbsSidePlankOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
