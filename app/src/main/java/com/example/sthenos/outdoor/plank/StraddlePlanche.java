...
import static com.example.sthenos.R.drawable.straddleplanche;

public class StraddlePlanche extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(straddleplanche);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Straddle planche");

        levelTag.setText("Advanced");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Back, Shoulders, Core, Straight Arm Strength");

        descText.setText("Make sure your arms and legs are completely straight and keep the legs wide");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StraddlePlanche.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StraddlePlanche.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(StraddlePlanche.this, IndoorActivity.class);
                        Toast.makeText(StraddlePlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(StraddlePlanche.this, OutdoorActivity.class);
                        Toast.makeText(StraddlePlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(StraddlePlanche.this, MainActivity.class);
                        Toast.makeText(StraddlePlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(StraddlePlanche.this, MobilityActivity.class);
                        Toast.makeText(StraddlePlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(StraddlePlanche.this, Equipment.class);
                        Toast.makeText(StraddlePlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
