...
import static com.example.sthenos.R.drawable.hs_straddle;

public class StradHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(hs_straddle);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Straddle handstand");
        ...
        descText.setText("To get into a handstand use one leg to kick up and keep the other one straight," +
                " when in a handstand keep your legs straight and as wide as possible makes it easier to balance.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StradHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StradHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(StradHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(StradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(StradHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(StradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(StradHSOutdoor.this, MainActivity.class);
                        Toast.makeText(StradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(StradHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(StradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(StradHSOutdoor.this, Equipment.class);
                        Toast.makeText(StradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
