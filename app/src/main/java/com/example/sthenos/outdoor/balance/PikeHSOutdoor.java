...
import static com.example.sthenos.R.drawable.hs_pike_assisted;

public class PikeHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(hs_pike_assisted);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Pike handstand");
        ...
        descText.setText("Use something to assist your pike hold to get comfortable being upside down" +
                "and move forward in progression to achieve a full handstand");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PikeHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PikeHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(PikeHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(PikeHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(PikeHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(PikeHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(PikeHSOutdoor.this, MainActivity.class);
                        Toast.makeText(PikeHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(PikeHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(PikeHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(PikeHSOutdoor.this, Equipment.class);
                        Toast.makeText(PikeHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
