...
import com.example.sthenos.indoor.pullups.NegativePullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.negativepullups;

public class NegativePullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(negativepullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Negative Pull Ups");
        ...
        descText.setText("Get on top of the bar climbing on it. Then slowly go down to train the" +
                "necessary muscles to learn the regular pull up");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NegativePullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NegativePullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(NegativePullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(NegativePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(NegativePullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(NegativePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(NegativePullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(NegativePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(NegativePullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(NegativePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(NegativePullUpOutdoor.this, Equipment.class);
                        Toast.makeText(NegativePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
