...
import static com.example.sthenos.R.drawable.squatpng;

public class SquatOutside extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(squatpng);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Regular Squat");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SquatOutside.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SquatOutside.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(SquatOutside.this, IndoorActivity.class);
                        Toast.makeText(SquatOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(SquatOutside.this, OutdoorActivity.class);
                        Toast.makeText(SquatOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(SquatOutside.this, MainActivity.class);
                        Toast.makeText(SquatOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(SquatOutside.this, MobilityActivity.class);
                        Toast.makeText(SquatOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(SquatOutside.this, Equipment.class);
                        Toast.makeText(SquatOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
