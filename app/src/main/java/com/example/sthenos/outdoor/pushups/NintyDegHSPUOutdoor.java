...
import com.example.sthenos.indoor.pushups.NintyDegreeHSPU;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable._0degreepushups;

public class NintyDegHSPUOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(_0degreepushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("90 Degree handstand push-ups (Level 85)");

        levelTag.setText("Pro");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Triceps, Shoulders, Chest");

        descText.setText("Handstand push-up, but you end up parallel to the ground and go back up to a normal handstand");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NintyDegHSPUOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NintyDegHSPUOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(NintyDegHSPUOutdoor.this, IndoorActivity.class);
                        Toast.makeText(NintyDegHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(NintyDegHSPUOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(NintyDegHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(NintyDegHSPUOutdoor.this, MainActivity.class);
                        Toast.makeText(NintyDegHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(NintyDegHSPUOutdoor.this, MobilityActivity.class);
                        Toast.makeText(NintyDegHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(NintyDegHSPUOutdoor.this, Equipment.class);
                        Toast.makeText(NintyDegHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
