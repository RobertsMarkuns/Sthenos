...
import com.example.sthenos.indoor.pushups.HandstandPushUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.hspu;

public class HSPUOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseTitle.setText("Handstand push-ups (Level 75)");
        ...
        descText.setText("Get into a free standing handstand and push-up, make sure to have good balance before" +
                "attempting it without a wall");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HSPUOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HSPUOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(HSPUOutdoor.this, IndoorActivity.class);
                        Toast.makeText(HSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(HSPUOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(HSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(HSPUOutdoor.this, MainActivity.class);
                        Toast.makeText(HSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(HSPUOutdoor.this, MobilityActivity.class);
                        Toast.makeText(HSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(HSPUOutdoor.this, Equipment.class);
                        Toast.makeText(HSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
