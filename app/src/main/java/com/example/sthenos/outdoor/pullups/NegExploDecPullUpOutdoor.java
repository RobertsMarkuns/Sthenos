...
import com.example.sthenos.indoor.pullups.NegativeExplosiveDeclinePullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.negative_explosivedecline_pullups;

public class NegExploDecPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NegExploDecPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NegExploDecPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(NegExploDecPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(NegExploDecPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(NegExploDecPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(NegExploDecPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(NegExploDecPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(NegExploDecPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(NegExploDecPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(NegExploDecPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(NegExploDecPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(NegExploDecPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
