...
import static com.example.sthenos.R.drawable.fullplanche;

public class FullPlanche extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(fullplanche);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Full planche");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FullPlanche.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FullPlanche.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(FullPlanche.this, IndoorActivity.class);
                        Toast.makeText(FullPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(FullPlanche.this, OutdoorActivity.class);
                        Toast.makeText(FullPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(FullPlanche.this, MainActivity.class);
                        Toast.makeText(FullPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(FullPlanche.this, MobilityActivity.class);
                        Toast.makeText(FullPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(FullPlanche.this, Equipment.class);
                        Toast.makeText(FullPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
