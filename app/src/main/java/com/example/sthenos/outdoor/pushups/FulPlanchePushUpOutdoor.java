...
import com.example.sthenos.indoor.pushups.FullPlanchePushUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.fullplanchepushups;

public class FulPlanchePushUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(fullplanchepushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Full planche push-ups (Level 95)");
        ...
        descText.setText("Get in a full planche and try to go as low as possible. The lower the harder, but better");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FulPlanchePushUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FulPlanchePushUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(FulPlanchePushUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(FulPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(FulPlanchePushUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(FulPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(FulPlanchePushUpOutdoor.this, MainActivity.class);
                        Toast.makeText(FulPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(FulPlanchePushUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(FulPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(FulPlanchePushUpOutdoor.this, Equipment.class);
                        Toast.makeText(FulPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
