...
import com.example.sthenos.indoor.pullups.ArcherPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.archerpullups;

public class ArcherPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(archerpullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Archer Pull Ups");

        levelTag.setText("Intermediate");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Biceps, Back, Shoulders");

        descText.setText("When doing the archer pull up make sure to stay straight and engage your entire body. " +
                "When you pull up stretch out one arm and get as close to your other then next pull up switch arms. " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ArcherPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ArcherPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(ArcherPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(ArcherPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(ArcherPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(ArcherPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(ArcherPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(ArcherPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(ArcherPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(ArcherPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(ArcherPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(ArcherPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
