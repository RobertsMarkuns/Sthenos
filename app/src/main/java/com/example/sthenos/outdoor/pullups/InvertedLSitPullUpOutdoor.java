...
import com.example.sthenos.indoor.pullups.InvertedLSitPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.inverted_lsit_pullup;

public class InvertedLSitPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(inverted_lsit_pullup);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Inverted L-Sit Pull Ups");

        levelTag.setText("Advanced");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Biceps, Back, Core");

        descText.setText("When doing the inverted L-sit pull up make sure to stay straight and engage your entire body. " +
                "When you pull up have your legs in 90 degree above the bar and pull your waste as close to the bar " +
                "as you can. " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(InvertedLSitPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InvertedLSitPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(InvertedLSitPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(InvertedLSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(InvertedLSitPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(InvertedLSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(InvertedLSitPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(InvertedLSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(InvertedLSitPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(InvertedLSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(InvertedLSitPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(InvertedLSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
