...
import static com.example.sthenos.R.drawable.handstandpng;

public class HandstandOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(handstandpng);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Handstand");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HandstandOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HandstandOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(HandstandOutdoor.this, IndoorActivity.class);
                        Toast.makeText(HandstandOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(HandstandOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(HandstandOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(HandstandOutdoor.this, MainActivity.class);
                        Toast.makeText(HandstandOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(HandstandOutdoor.this, MobilityActivity.class);
                        Toast.makeText(HandstandOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(HandstandOutdoor.this, Equipment.class);
                        Toast.makeText(HandstandOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
