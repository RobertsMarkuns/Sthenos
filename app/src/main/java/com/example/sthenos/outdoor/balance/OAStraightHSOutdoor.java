...
import static com.example.sthenos.R.drawable.onearmhs_w_legstogether;

public class OAStraightHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(onearmhs_w_legstogether);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("One arm straight");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OAStraightHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OAStraightHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(OAStraightHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(OAStraightHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(OAStraightHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(OAStraightHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(OAStraightHSOutdoor.this, MainActivity.class);
                        Toast.makeText(OAStraightHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(OAStraightHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(OAStraightHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(OAStraightHSOutdoor.this, Equipment.class);
                        Toast.makeText(OAStraightHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
