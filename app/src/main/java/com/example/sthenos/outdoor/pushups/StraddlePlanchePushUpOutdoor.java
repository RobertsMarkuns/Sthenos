...
import com.example.sthenos.indoor.pushups.StraddlePlanchePushUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.straddleplanchepushups;

public class StraddlePlanchePushUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StraddlePlanchePushUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StraddlePlanchePushUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(StraddlePlanchePushUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(StraddlePlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(StraddlePlanchePushUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(StraddlePlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(StraddlePlanchePushUpOutdoor.this, MainActivity.class);
                        Toast.makeText(StraddlePlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(StraddlePlanchePushUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(StraddlePlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(StraddlePlanchePushUpOutdoor.this, Equipment.class);
                        Toast.makeText(StraddlePlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
