...
public class StarJumpsOutside extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(star_jumps_exercise);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("StarJumps");

        levelTag.setText("Novice");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Shoulders, Legs, Cardio");

        descText.setText("Start from a standing still position when you jump put your legs shoulder width apart" +
                " and arms above your head and then go back to the normal position");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StarJumpsOutside.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StarJumpsOutside.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(StarJumpsOutside.this, IndoorActivity.class);
                        Toast.makeText(StarJumpsOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(StarJumpsOutside.this, OutdoorActivity.class);
                        Toast.makeText(StarJumpsOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(StarJumpsOutside.this, MainActivity.class);
                        Toast.makeText(StarJumpsOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(StarJumpsOutside.this, MobilityActivity.class);
                        Toast.makeText(StarJumpsOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(StarJumpsOutside.this, Equipment.class);
                        Toast.makeText(StarJumpsOutside.this, item.getTitle(), Toast.LENGTH_SHORT).show();
