...
import static com.example.sthenos.R.drawable.scorpionhs;

public class ScorpHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(scorpionhs);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Scorpion handstand");
        ...
        descText.setText("To get into a handstand use one leg to kick up and keep the other one straight," +
                " when in a handstand bend your legs and keep your legs bent.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ScorpHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ScorpHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(ScorpHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(ScorpHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(ScorpHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(ScorpHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(ScorpHSOutdoor.this, MainActivity.class);
                        Toast.makeText(ScorpHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(ScorpHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(ScorpHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(ScorpHSOutdoor.this, Equipment.class);
                        Toast.makeText(ScorpHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
