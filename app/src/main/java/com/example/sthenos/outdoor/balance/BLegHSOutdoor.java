...
public class BLegHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(bentleghs);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Bent leg handstand");
        ...
        descText.setText("To get into a handstand use one leg to kick up and keep the other one straight," +
                " when in a handstand keep your legs bent and as wide as possible makes it easier to balance.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BLegHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BLegHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(BLegHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(BLegHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(BLegHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(BLegHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(BLegHSOutdoor.this, MainActivity.class);
                        Toast.makeText(BLegHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(BLegHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(BLegHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(BLegHSOutdoor.this, Equipment.class);
                        Toast.makeText(BLegHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
