...
import com.example.sthenos.indoor.pushups.KneePushUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.kneepushups;

public class KneePushUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(kneepushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Knee push-ups (Level 2)");
        ...
        descText.setText("Push-up with your ankles on the floor.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KneePushUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KneePushUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(KneePushUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(KneePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(KneePushUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(KneePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(KneePushUpOutdoor.this, MainActivity.class);
                        Toast.makeText(KneePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(KneePushUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(KneePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(KneePushUpOutdoor.this, Equipment.class);
                        Toast.makeText(KneePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
