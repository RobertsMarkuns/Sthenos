...
import com.example.sthenos.indoor.pullups.FrontLeverPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.frontleverpullups;

public class FrontLeverPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(frontleverpullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Front Lever Pull Ups");

        levelTag.setText("Pro");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Biceps, Back, Core, Shoulders");

        descText.setText("When doing a front lever pull up make sure to engage your entire body and keep straight." +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FrontLeverPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FrontLeverPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(FrontLeverPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(FrontLeverPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(FrontLeverPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(FrontLeverPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(FrontLeverPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(FrontLeverPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(FrontLeverPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(FrontLeverPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(FrontLeverPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(FrontLeverPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
