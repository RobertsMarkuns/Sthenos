...
import com.example.sthenos.indoor.pushups.DeepHSPU;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.deephspu;

public class DeepHSPUOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(deephspu);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Deep handstand push-ups (Level 77)");
        ...
        descText.setText("Get into a free standing handstand on parallel bars and try to go as deep as possible." +
                "Make sure you have mastered a standard handstand push-up.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeepHSPUOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeepHSPUOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(DeepHSPUOutdoor.this, IndoorActivity.class);
                        Toast.makeText(DeepHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(DeepHSPUOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(DeepHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(DeepHSPUOutdoor.this, MainActivity.class);
                        Toast.makeText(DeepHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(DeepHSPUOutdoor.this, MobilityActivity.class);
                        Toast.makeText(DeepHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(DeepHSPUOutdoor.this, Equipment.class);
                        Toast.makeText(DeepHSPUOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
