...
import com.example.sthenos.indoor.pullups.OneArmPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.onearmpullup;

public class OneArmPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OneArmPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OneArmPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(OneArmPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(OneArmPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(OneArmPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(OneArmPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(OneArmPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(OneArmPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(OneArmPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(OneArmPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(OneArmPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(OneArmPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
