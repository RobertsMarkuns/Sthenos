...
import static com.example.sthenos.R.drawable.oahs_diamond;

public class OADHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(oahs_diamond);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("One arm diamond");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OADHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OADHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(OADHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(OADHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(OADHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(OADHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(OADHSOutdoor.this, MainActivity.class);
                        Toast.makeText(OADHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(OADHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(OADHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(OADHSOutdoor.this, Equipment.class);
                        Toast.makeText(OADHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
