...
import static com.example.sthenos.R.drawable.frontlever;

public class Front_leverOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(frontlever);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Frontlever");

        levelTag.setText("Advanced");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Shoulders, Core, Back");

        descText.setText("Keep your body straight as possible");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Front_leverOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Front_leverOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(Front_leverOutdoor.this, IndoorActivity.class);
                        Toast.makeText(Front_leverOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(Front_leverOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(Front_leverOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(Front_leverOutdoor.this, MainActivity.class);
                        Toast.makeText(Front_leverOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(Front_leverOutdoor.this, MobilityActivity.class);
                        Toast.makeText(Front_leverOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(Front_leverOutdoor.this, Equipment.class);
                        Toast.makeText(Front_leverOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
