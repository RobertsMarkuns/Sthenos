...
import static com.example.sthenos.R.drawable.forearmhs;

public class ForearmHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(forearmhs);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Forearm handstand");
        ...
        descText.setText("To get into a handstand use one leg to kick up and keep the other one straight," +
                " when in a handstand keep your straight." +
                "This is an easier version of the normal handstand to pratice balance.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ForearmHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ForearmHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(ForearmHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(ForearmHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(ForearmHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(ForearmHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(ForearmHSOutdoor.this, MainActivity.class);
                        Toast.makeText(ForearmHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(ForearmHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(ForearmHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(ForearmHSOutdoor.this, Equipment.class);
                        Toast.makeText(ForearmHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
