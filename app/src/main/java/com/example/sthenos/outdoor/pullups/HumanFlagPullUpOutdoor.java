...
import com.example.sthenos.indoor.pullups.HumanFlagPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.humanflagpullups;

public class HumanFlagPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(humanflagpullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Human Flag Pull Ups");
        ...
        descText.setText("When doing a human flag pull up make sure to engage your entire body and keep straight. " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HumanFlagPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HumanFlagPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(HumanFlagPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(HumanFlagPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(HumanFlagPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(HumanFlagPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(HumanFlagPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(HumanFlagPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(HumanFlagPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(HumanFlagPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(HumanFlagPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(HumanFlagPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
