...
import com.example.sthenos.indoor.pushups.DeclinePushUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.declinepushups;

public class DeclinePushUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(declinepushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Decline push-ups (Level 8)");
        ...
        descText.setText("Push-up with your legs on something above ground");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeclinePushUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeclinePushUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(DeclinePushUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(DeclinePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(DeclinePushUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(DeclinePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(DeclinePushUpOutdoor.this, MainActivity.class);
                        Toast.makeText(DeclinePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(DeclinePushUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(DeclinePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(DeclinePushUpOutdoor.this, Equipment.class);
                        Toast.makeText(DeclinePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
