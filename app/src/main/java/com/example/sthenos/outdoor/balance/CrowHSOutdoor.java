...
import static com.example.sthenos.R.drawable.crow_hs;

public class CrowHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(crow_hs);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Crow handstand");
        ...
        descText.setText("To get into a handstand bend your arms slightly and get your knees right above your forearms." +
                "This is an easy party trick to learn.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CrowHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CrowHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(CrowHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(CrowHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(CrowHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(CrowHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(CrowHSOutdoor.this, MainActivity.class);
                        Toast.makeText(CrowHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(CrowHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(CrowHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(CrowHSOutdoor.this, Equipment.class);
                        Toast.makeText(CrowHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
