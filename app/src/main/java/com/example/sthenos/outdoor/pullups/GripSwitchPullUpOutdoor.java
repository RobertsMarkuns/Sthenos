...
import com.example.sthenos.indoor.pullups.GripSwitchPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.gripswitchpullups;

public class GripSwitchPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(gripswitchpullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Grip Switch Pull Ups");
        ...
        descText.setText("When doing the grip switch pull up make sure to stay straight and engage your entire body. " +
                "When you pull up, quickly switch the side of the bar your holding on every pull up. " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GripSwitchPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GripSwitchPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(GripSwitchPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(GripSwitchPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(GripSwitchPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(GripSwitchPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(GripSwitchPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(GripSwitchPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(GripSwitchPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(GripSwitchPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(GripSwitchPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(GripSwitchPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
