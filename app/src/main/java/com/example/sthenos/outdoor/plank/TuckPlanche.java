...
import static com.example.sthenos.R.drawable.tuckplanche;

public class TuckPlanche extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(tuckplanche);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Tuck planche");
        ...
        descText.setText("Make sure your arms are completely straight and tuck as close as possible");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TuckPlanche.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TuckPlanche.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(TuckPlanche.this, IndoorActivity.class);
                        Toast.makeText(TuckPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(TuckPlanche.this, OutdoorActivity.class);
                        Toast.makeText(TuckPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(TuckPlanche.this, MainActivity.class);
                        Toast.makeText(TuckPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(TuckPlanche.this, MobilityActivity.class);
                        Toast.makeText(TuckPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(TuckPlanche.this, Equipment.class);
                        Toast.makeText(TuckPlanche.this, item.getTitle(), Toast.LENGTH_SHORT).show();
