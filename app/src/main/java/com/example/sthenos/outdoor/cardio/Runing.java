...
import static com.example.sthenos.R.drawable.runing;
...
public class Runing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(runing);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Runing");

        levelTag.setText("None");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Legs, Core, Cardio");

        descText.setText("When running make sure to inhale air to the full capacity of your lungs to " +
                "have as much oxygen as possible, this will prevent shortness of breath and won't require you to rest" +
                ", but be sure to take necessary breaks if your new to running, over time you will be able to" +
                " run longer distances, for beginners start with short distances and work your way up  " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Runing.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Runing.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(Runing.this, IndoorActivity.class);
                        Toast.makeText(Runing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(Runing.this, OutdoorActivity.class);
                        Toast.makeText(Runing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(Runing.this, MainActivity.class);
                        Toast.makeText(Runing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(Runing.this, MobilityActivity.class);
                        Toast.makeText(Runing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(Runing.this, Equipment.class);
                        Toast.makeText(Runing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
