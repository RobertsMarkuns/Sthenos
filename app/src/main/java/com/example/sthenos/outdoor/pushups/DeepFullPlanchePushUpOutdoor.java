...
import com.example.sthenos.indoor.pushups.DeepFullPlanchePushUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.deepfullplanchepushups;

public class DeepFullPlanchePushUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(deepfullplanchepushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Deep full planche push-ups (Level 100)");
        ...
        descText.setText("Get in a full planche on the parallel bars and try to go as low as possible." +
                " The lower the harder, but the better");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeepFullPlanchePushUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DeepFullPlanchePushUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(DeepFullPlanchePushUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(DeepFullPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(DeepFullPlanchePushUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(DeepFullPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(DeepFullPlanchePushUpOutdoor.this, MainActivity.class);
                        Toast.makeText(DeepFullPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(DeepFullPlanchePushUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(DeepFullPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(DeepFullPlanchePushUpOutdoor.this, Equipment.class);
                        Toast.makeText(DeepFullPlanchePushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
