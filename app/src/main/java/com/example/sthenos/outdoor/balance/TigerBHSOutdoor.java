...
import static com.example.sthenos.R.drawable.tigerbendhs;

public class TigerBHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(tigerbendhs);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Tiger bend");
        ...
        descText.setText("To get into a handstand use one leg to kick up and keep the other one straight," +
                " when in a handstand keep your legs bent and hold.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TigerBHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TigerBHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(TigerBHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(TigerBHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(TigerBHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(TigerBHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(TigerBHSOutdoor.this, MainActivity.class);
                        Toast.makeText(TigerBHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(TigerBHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(TigerBHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(TigerBHSOutdoor.this, Equipment.class);
                        Toast.makeText(TigerBHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
