...
import com.example.sthenos.indoor.pullups.ExplosivePullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.explosivepullups;

public class ExplosivePullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(explosivepullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Explosive Pull Ups");
        ...
        descText.setText("When doing the explosive pull up make sure to stay straight and engage your entire body. " +
                "When you pull up try going as high as possible above the bar. " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ExplosivePullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ExplosivePullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(ExplosivePullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(ExplosivePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(ExplosivePullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(ExplosivePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(ExplosivePullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(ExplosivePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(ExplosivePullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(ExplosivePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(ExplosivePullUpOutdoor.this, Equipment.class);
                        Toast.makeText(ExplosivePullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
