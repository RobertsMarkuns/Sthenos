...
import static com.example.sthenos.R.drawable.oahs_straddle;

public class OAStradHSOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(oahs_straddle);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("One arm straddle");
        ...
        descText.setText("To get into a handstand use one leg to kick up and keep the other one straight," +
                ...
                " when in a handstand keep your legs as wide as possible");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OAStradHSOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OAStradHSOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(OAStradHSOutdoor.this, IndoorActivity.class);
                        Toast.makeText(OAStradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(OAStradHSOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(OAStradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(OAStradHSOutdoor.this, MainActivity.class);
                        Toast.makeText(OAStradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(OAStradHSOutdoor.this, MobilityActivity.class);
                        Toast.makeText(OAStradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(OAStradHSOutdoor.this, Equipment.class);
                        Toast.makeText(OAStradHSOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
