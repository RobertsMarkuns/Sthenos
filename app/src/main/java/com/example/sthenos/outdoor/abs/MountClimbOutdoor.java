...
import static com.example.sthenos.R.drawable.mountainclimbers;

public class MountClimbOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(mountainclimbers);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Mountain Climbers");
        ...
        descText.setText("Get your knees as close to your chest as possible");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MountClimbOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MountClimbOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(MountClimbOutdoor.this, IndoorActivity.class);
                        Toast.makeText(MountClimbOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(MountClimbOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(MountClimbOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(MountClimbOutdoor.this, MainActivity.class);
                        Toast.makeText(MountClimbOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(MountClimbOutdoor.this, MobilityActivity.class);
                        Toast.makeText(MountClimbOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(MountClimbOutdoor.this, Equipment.class);
                        Toast.makeText(MountClimbOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
