...
import com.example.sthenos.indoor.pullups.LSitPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.l_sitpullups;

public class LSitPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(l_sitpullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("L-Sit Pull Ups");

        levelTag.setText("Intermediate");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Biceps, Back, Shoulders, Core");

        descText.setText("When doing the L-sit pull up make sure to stay straight and engage your entire body. " +
                "When you pull up keep your legs at a 90 degree angle. " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LSitPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LSitPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(LSitPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(LSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(LSitPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(LSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(LSitPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(LSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(LSitPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(LSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(LSitPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(LSitPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
