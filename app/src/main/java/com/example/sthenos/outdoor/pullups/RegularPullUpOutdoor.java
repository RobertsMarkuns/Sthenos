...
import com.example.sthenos.indoor.pullups.RegularPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.regularpullups;

public class RegularPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(regularpullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Regular Pull Ups");
        ...
        descText.setText("When doing the regular pull up make sure to stay straight and engage your entire body " +
                "for better results. Never sacrifice form for reps");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RegularPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RegularPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(RegularPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(RegularPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(RegularPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(RegularPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(RegularPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(RegularPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(RegularPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(RegularPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(RegularPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(RegularPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
