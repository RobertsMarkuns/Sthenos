...
import com.example.sthenos.indoor.pushups.ArcherPushUps;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.archerpushups;

public class ArchPushUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(archerpushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Archer push-ups (Level 35)");
        ...
        descText.setText("Put your arms as wide as possible and keep them straight");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ArchPushUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ArchPushUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(ArchPushUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(ArchPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(ArchPushUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(ArchPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(ArchPushUpOutdoor.this, MainActivity.class);
                        Toast.makeText(ArchPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(ArchPushUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(ArchPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(ArchPushUpOutdoor.this, Equipment.class);
                        Toast.makeText(ArchPushUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
