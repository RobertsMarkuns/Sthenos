...
import com.example.sthenos.indoor.pullups.AustralianBKPullUps;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.australianpullups;

public class AustralianBKPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(australianpullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Australian Pull Ups (bent knees)");
        ...
        descText.setText("Find something low where you can hold onto to do these pull-ups." +
                "When pulling up bend your knees to make it easier.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AustralianBKPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AustralianBKPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(AustralianBKPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(AustralianBKPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(AustralianBKPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(AustralianBKPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(AustralianBKPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(AustralianBKPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(AustralianBKPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(AustralianBKPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(AustralianBKPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(AustralianBKPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
