...
import com.example.sthenos.indoor.pullups.CloseGripPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.closegrippullups;

public class CloseGripPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(closegrippullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Close Grip Pull Ups");
        ...
        descText.setText("When doing the close grip pull up make sure to stay straight and engage your entire body" +
                "and keep your hand close together. " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CloseGripPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CloseGripPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(CloseGripPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(CloseGripPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(CloseGripPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(CloseGripPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(CloseGripPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(CloseGripPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(CloseGripPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(CloseGripPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(CloseGripPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(CloseGripPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
