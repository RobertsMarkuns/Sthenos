...
public class CrunchesOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(crunches);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Crunches");
        ...
        descText.setText("Keep your legs together and close, don't put hands behind your head," +
                "keep them on your chest");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CrunchesOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CrunchesOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(CrunchesOutdoor.this, IndoorActivity.class);
                        Toast.makeText(CrunchesOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(CrunchesOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(CrunchesOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(CrunchesOutdoor.this, MainActivity.class);
                        Toast.makeText(CrunchesOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(CrunchesOutdoor.this, MobilityActivity.class);
                        Toast.makeText(CrunchesOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(CrunchesOutdoor.this, Equipment.class);
                        Toast.makeText(CrunchesOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
