...
import com.example.sthenos.indoor.pullups.JumpPullUps;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.jumppullups;

public class JumpPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(jumppullups);
        ...
        descText.setText("Get on top of the bar by jumping on it. Then slowly go down to train the" +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JumpPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JumpPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(JumpPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(JumpPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(JumpPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(JumpPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(JumpPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(JumpPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(JumpPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(JumpPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(JumpPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(JumpPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
