...
import static com.example.sthenos.R.drawable.hangingl_sit;

public class HangingL_SitOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(hangingl_sit);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Hanging L-Sit");
        ...
        descText.setText("Keep your legs 90 degrees");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HangingL_SitOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HangingL_SitOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(HangingL_SitOutdoor.this, IndoorActivity.class);
                        Toast.makeText(HangingL_SitOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(HangingL_SitOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(HangingL_SitOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(HangingL_SitOutdoor.this, MainActivity.class);
                        Toast.makeText(HangingL_SitOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(HangingL_SitOutdoor.this, MobilityActivity.class);
                        Toast.makeText(HangingL_SitOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(HangingL_SitOutdoor.this, Equipment.class);
                        Toast.makeText(HangingL_SitOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
