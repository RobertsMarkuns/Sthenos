...
import com.example.sthenos.indoor.pushups.FullPlanchePushUpFTG;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.fullplanchepushupsftg;

public class FulPlanchPushFTGOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FulPlanchPushFTGOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FulPlanchPushFTGOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(FulPlanchPushFTGOutdoor.this, IndoorActivity.class);
                        Toast.makeText(FulPlanchPushFTGOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(FulPlanchPushFTGOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(FulPlanchPushFTGOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(FulPlanchPushFTGOutdoor.this, MainActivity.class);
                        Toast.makeText(FulPlanchPushFTGOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(FulPlanchPushFTGOutdoor.this, MobilityActivity.class);
                        Toast.makeText(FulPlanchPushFTGOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(FulPlanchPushFTGOutdoor.this, Equipment.class);
                        Toast.makeText(FulPlanchPushFTGOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
