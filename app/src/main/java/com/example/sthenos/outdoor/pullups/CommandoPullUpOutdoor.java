...
import com.example.sthenos.indoor.pullups.CommandoPullUp;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.commandopullups;

public class CommandoPullUpOutdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(commandopullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Commando Pull Ups");
        ...
        descText.setText("When doing the commando pull up make sure to stay straight and engage your entire body. " +
                "Keep switching sides when doing the pull up. Never sacrifice form for reps");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CommandoPullUpOutdoor.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CommandoPullUpOutdoor.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(CommandoPullUpOutdoor.this, IndoorActivity.class);
                        Toast.makeText(CommandoPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(CommandoPullUpOutdoor.this, OutdoorActivity.class);
                        Toast.makeText(CommandoPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(CommandoPullUpOutdoor.this, MainActivity.class);
                        Toast.makeText(CommandoPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(CommandoPullUpOutdoor.this, MobilityActivity.class);
                        Toast.makeText(CommandoPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(CommandoPullUpOutdoor.this, Equipment.class);
                        Toast.makeText(CommandoPullUpOutdoor.this, item.getTitle(), Toast.LENGTH_SHORT).show();
