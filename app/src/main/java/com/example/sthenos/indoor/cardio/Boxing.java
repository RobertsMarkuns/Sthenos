...
import static com.example.sthenos.R.drawable.boxing;
...
public class Boxing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(boxing);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Boxing");

        levelTag.setText("None");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Arms, Legs, Core, Hand eye coordination, Cardio");

        descText.setText("A fun yet dangerous way to do cardio is sparing someone," +
                "this ones for the people that like adrenaline and aren't afraid to test their limits" +
                "and go beyond to show their strength.");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Boxing.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Boxing.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(Boxing.this, IndoorActivity.class);
                        Toast.makeText(Boxing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(Boxing.this, OutdoorActivity.class);
                        Toast.makeText(Boxing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(Boxing.this, MainActivity.class);
                        Toast.makeText(Boxing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(Boxing.this, MobilityActivity.class);
                        Toast.makeText(Boxing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(Boxing.this, Equipment.class);
                        Toast.makeText(Boxing.this, item.getTitle(), Toast.LENGTH_SHORT).show();
