...
import static com.example.sthenos.R.drawable.bentleghs;
import static com.example.sthenos.R.drawable.handstandonbar;

public class HSOnABar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(handstandonbar);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Handstand on a bar");
        ...
        descText.setText("To get into a handstand by doing a handstand press, but be very careful," +
                "this is a very dangerous move and should only be attempted by experienced or trained professionals ");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HSOnABar.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HSOnABar.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(HSOnABar.this, IndoorActivity.class);
                        Toast.makeText(HSOnABar.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(HSOnABar.this, OutdoorActivity.class);
                        Toast.makeText(HSOnABar.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(HSOnABar.this, MainActivity.class);
                        Toast.makeText(HSOnABar.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(HSOnABar.this, MobilityActivity.class);
                        Toast.makeText(HSOnABar.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(HSOnABar.this, Equipment.class);
                        Toast.makeText(HSOnABar.this, item.getTitle(), Toast.LENGTH_SHORT).show();
