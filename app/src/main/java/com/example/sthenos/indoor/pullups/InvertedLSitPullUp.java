...
public class InvertedLSitPullUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(InvertedLSitPullUp.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InvertedLSitPullUp.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(InvertedLSitPullUp.this, IndoorActivity.class);
                        Toast.makeText(InvertedLSitPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(InvertedLSitPullUp.this, OutdoorActivity.class);
                        Toast.makeText(InvertedLSitPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(InvertedLSitPullUp.this, MainActivity.class);
                        Toast.makeText(InvertedLSitPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(InvertedLSitPullUp.this, MobilityActivity.class);
                        Toast.makeText(InvertedLSitPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(InvertedLSitPullUp.this, Equipment.class);
                        Toast.makeText(InvertedLSitPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
