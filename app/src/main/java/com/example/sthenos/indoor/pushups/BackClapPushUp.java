...
public class BackClapPushUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseTitle.setText("Back clap push-ups (Level 55)");
        ...
        descText.setText("Get into a regular push up position and try accelarate and go as high as possible to have time" +
                "to do a back clap");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BackClapPushUp.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BackClapPushUp.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(BackClapPushUp.this, IndoorActivity.class);
                        Toast.makeText(BackClapPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(BackClapPushUp.this, OutdoorActivity.class);
                        Toast.makeText(BackClapPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(BackClapPushUp.this, MainActivity.class);
                        Toast.makeText(BackClapPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(BackClapPushUp.this, MobilityActivity.class);
                        Toast.makeText(BackClapPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(BackClapPushUp.this, Equipment.class);
                        Toast.makeText(BackClapPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
