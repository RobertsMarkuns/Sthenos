...
import static com.example.sthenos.R.drawable.v_sitholdonfloor;
import static com.example.sthenos.R.drawable.windshieldwipers;

public class WindshieldWipers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(windshieldwipers);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Windshield wipers");

        levelTag.setText("Intermediate");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Abs");

        descText.setText("Keep your legs straight, 90 degrees and go from side to side");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WindshieldWipers.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WindshieldWipers.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(WindshieldWipers.this, IndoorActivity.class);
                        Toast.makeText(WindshieldWipers.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(WindshieldWipers.this, OutdoorActivity.class);
                        Toast.makeText(WindshieldWipers.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(WindshieldWipers.this, MainActivity.class);
                        Toast.makeText(WindshieldWipers.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(WindshieldWipers.this, MobilityActivity.class);
                        Toast.makeText(WindshieldWipers.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(WindshieldWipers.this, Equipment.class);
                        Toast.makeText(WindshieldWipers.this, item.getTitle(), Toast.LENGTH_SHORT).show();
