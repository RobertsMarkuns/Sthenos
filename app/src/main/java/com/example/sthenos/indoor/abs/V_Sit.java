...
public class V_Sit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(v_sitholdonfloor);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("V-Sit");

        levelTag.setText("Advanced");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Abs, Triceps");

        descText.setText("Try to get your legs as high as possible and keep your feet pointed");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(V_Sit.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(V_Sit.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(V_Sit.this, IndoorActivity.class);
                        Toast.makeText(V_Sit.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(V_Sit.this, OutdoorActivity.class);
                        Toast.makeText(V_Sit.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(V_Sit.this, MainActivity.class);
                        Toast.makeText(V_Sit.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(V_Sit.this, MobilityActivity.class);
                        Toast.makeText(V_Sit.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(V_Sit.this, Equipment.class);
                        Toast.makeText(V_Sit.this, item.getTitle(), Toast.LENGTH_SHORT).show();
