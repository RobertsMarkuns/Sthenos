...
import static com.example.sthenos.R.drawable.crunches;
import static com.example.sthenos.R.drawable.sidecrunches;

public class SideCrunches extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(sidecrunches);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Side crunches");
        ...
        descText.setText("Change legs and knees every rep. Don't put arms behind your leg");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SideCrunches.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SideCrunches.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(SideCrunches.this, IndoorActivity.class);
                        Toast.makeText(SideCrunches.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(SideCrunches.this, OutdoorActivity.class);
                        Toast.makeText(SideCrunches.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(SideCrunches.this, MainActivity.class);
                        Toast.makeText(SideCrunches.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(SideCrunches.this, MobilityActivity.class);
                        Toast.makeText(SideCrunches.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(SideCrunches.this, Equipment.class);
                        Toast.makeText(SideCrunches.this, item.getTitle(), Toast.LENGTH_SHORT).show();
