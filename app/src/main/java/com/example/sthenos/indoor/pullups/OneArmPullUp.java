...
import static com.example.sthenos.R.drawable.onearmpullup;

public class OneArmPullUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(onearmpullup);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("One Arm Pull Ups");
        ...
        descText.setText("When doing the one arm pull up make sure to engage your entire body. " +
                "When you pull up hold your hand on your shoulder and keep yourself straight " +
                "as you can. " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(OneArmPullUp.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OneArmPullUp.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(OneArmPullUp.this, IndoorActivity.class);
                        Toast.makeText(OneArmPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(OneArmPullUp.this, OutdoorActivity.class);
                        Toast.makeText(OneArmPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(OneArmPullUp.this, MainActivity.class);
                        Toast.makeText(OneArmPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(OneArmPullUp.this, MobilityActivity.class);
                        Toast.makeText(OneArmPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(OneArmPullUp.this, Equipment.class);
                        Toast.makeText(OneArmPullUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
