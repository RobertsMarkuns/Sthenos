...
import static com.example.sthenos.R.drawable.runingontreadmill;

public class RuningOnATreadmill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(runingontreadmill);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Running on a treadmill");
        ...
        descText.setText("Run at different speeds based on your capability");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RuningOnATreadmill.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RuningOnATreadmill.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(RuningOnATreadmill.this, IndoorActivity.class);
                        Toast.makeText(RuningOnATreadmill.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(RuningOnATreadmill.this, OutdoorActivity.class);
                        Toast.makeText(RuningOnATreadmill.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(RuningOnATreadmill.this, MainActivity.class);
                        Toast.makeText(RuningOnATreadmill.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(RuningOnATreadmill.this, MobilityActivity.class);
                        Toast.makeText(RuningOnATreadmill.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(RuningOnATreadmill.this, Equipment.class);
                        Toast.makeText(RuningOnATreadmill.this, item.getTitle(), Toast.LENGTH_SHORT).show();
