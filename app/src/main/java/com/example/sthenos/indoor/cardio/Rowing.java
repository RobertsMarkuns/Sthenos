...
import static com.example.sthenos.R.drawable.rowing;
...
public class Rowing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(rowing);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Rowing");

        levelTag.setText("None");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Back, Legs, Arms, Cardio");

        descText.setText("Choose a difficulty that lets you keep up a good pace whilst not being to easy" +
                "to go fast");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Rowing .this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rowing .this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(Rowing .this, IndoorActivity.class);
                        Toast.makeText(Rowing .this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(Rowing .this, OutdoorActivity.class);
                        Toast.makeText(Rowing .this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(Rowing .this, MainActivity.class);
                        Toast.makeText(Rowing .this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(Rowing .this, MobilityActivity.class);
                        Toast.makeText(Rowing .this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(Rowing .this, Equipment.class);
                        Toast.makeText(Rowing .this, item.getTitle(), Toast.LENGTH_SHORT).show();
