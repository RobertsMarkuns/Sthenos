...
import static com.example.sthenos.R.drawable.pikepushups;
...
public class PikePushUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(pikepushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Pike push-ups (Level 30)");
        ...
        descText.setText("Keep your legs and torso straight");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PikePushUp.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PikePushUp.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(PikePushUp.this, IndoorActivity.class);
                        Toast.makeText(PikePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(PikePushUp.this, OutdoorActivity.class);
                        Toast.makeText(PikePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(PikePushUp.this, MainActivity.class);
                        Toast.makeText(PikePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(PikePushUp.this, MobilityActivity.class);
                        Toast.makeText(PikePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(PikePushUp.this, Equipment.class);
                        Toast.makeText(PikePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
