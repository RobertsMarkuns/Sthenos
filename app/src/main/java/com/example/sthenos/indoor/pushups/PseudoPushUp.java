...
import static com.example.sthenos.R.drawable.pseudopushups;

public class PseudoPushUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(pseudopushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Pseudo push-ups (Level 40)");
        ...
        descText.setText("Push-up with your arms as close to your hips");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PseudoPushUp.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PseudoPushUp.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(PseudoPushUp.this, IndoorActivity.class);
                        Toast.makeText(PseudoPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(PseudoPushUp.this, OutdoorActivity.class);
                        Toast.makeText(PseudoPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(PseudoPushUp.this, MainActivity.class);
                        Toast.makeText(PseudoPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(PseudoPushUp.this, MobilityActivity.class);
                        Toast.makeText(PseudoPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(PseudoPushUp.this, Equipment.class);
                        Toast.makeText(PseudoPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
