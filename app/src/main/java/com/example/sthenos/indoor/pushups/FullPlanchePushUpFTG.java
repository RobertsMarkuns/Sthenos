...
import static com.example.sthenos.R.drawable.fullplanchepushupsftg;

public class FullPlanchePushUpFTG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(fullplanchepushupsftg);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Full planche push-ups from the ground (Level 98)");
        ...
        descText.setText("Get in a full planche on the ground and try get back in the air in the full planche position");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FullPlanchePushUpFTG.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FullPlanchePushUpFTG.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(FullPlanchePushUpFTG.this, IndoorActivity.class);
                        Toast.makeText(FullPlanchePushUpFTG.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(FullPlanchePushUpFTG.this, OutdoorActivity.class);
                        Toast.makeText(FullPlanchePushUpFTG.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(FullPlanchePushUpFTG.this, MainActivity.class);
                        Toast.makeText(FullPlanchePushUpFTG.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(FullPlanchePushUpFTG.this, MobilityActivity.class);
                        Toast.makeText(FullPlanchePushUpFTG.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(FullPlanchePushUpFTG.this, Equipment.class);
                        Toast.makeText(FullPlanchePushUpFTG.this, item.getTitle(), Toast.LENGTH_SHORT).show();
