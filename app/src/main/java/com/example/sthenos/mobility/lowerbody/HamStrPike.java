...
import static com.example.sthenos.R.drawable.hamstring_pike;
import static com.example.sthenos.R.drawable.hamstring_w_palmsonfloor;

public class HamStrPike extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(hamstring_pike);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Hamstring pike stretch");
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HamStrPike.this, Stopwatch.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(HamStrPike.this, IndoorActivity.class);
                        Toast.makeText(HamStrPike.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(HamStrPike.this, OutdoorActivity.class);
                        Toast.makeText(HamStrPike.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(HamStrPike.this, MainActivity.class);
                        Toast.makeText(HamStrPike.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(HamStrPike.this, MobilityActivity.class);
                        Toast.makeText(HamStrPike.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(HamStrPike.this, Equipment.class);
                        Toast.makeText(HamStrPike.this, item.getTitle(), Toast.LENGTH_SHORT).show();
