...
import static com.example.sthenos.R.drawable.hamstring_onelegonground;

public class HamStrLegOnGround extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(hamstring_onelegonground);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Hamstring one leg on the ground stretch");
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HamStrLegOnGround.this, Stopwatch.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(HamStrLegOnGround.this, IndoorActivity.class);
                        Toast.makeText(HamStrLegOnGround.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(HamStrLegOnGround.this, OutdoorActivity.class);
                        Toast.makeText(HamStrLegOnGround.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(HamStrLegOnGround.this, MainActivity.class);
                        Toast.makeText(HamStrLegOnGround.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(HamStrLegOnGround.this, MobilityActivity.class);
                        Toast.makeText(HamStrLegOnGround.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(HamStrLegOnGround.this, Equipment.class);
                        Toast.makeText(HamStrLegOnGround.this, item.getTitle(), Toast.LENGTH_SHORT).show();
