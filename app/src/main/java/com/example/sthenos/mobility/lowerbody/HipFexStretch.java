...
import static com.example.sthenos.R.drawable.hipflexorstretch;

public class HipFexStretch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(hipflexorstretch);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Hip flexor stretch");

        muscleGroupText.setText("Hip flexor");

        descText.setText("Stretch your Hip flexor by keeping legs straight and leaning as far backwards as possible");
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HipFexStretch.this, Stopwatch.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(HipFexStretch.this, IndoorActivity.class);
                        Toast.makeText(HipFexStretch.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(HipFexStretch.this, OutdoorActivity.class);
                        Toast.makeText(HipFexStretch.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(HipFexStretch.this, MainActivity.class);
                        Toast.makeText(HipFexStretch.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(HipFexStretch.this, MobilityActivity.class);
                        Toast.makeText(HipFexStretch.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(HipFexStretch.this, Equipment.class);
                        Toast.makeText(HipFexStretch.this, item.getTitle(), Toast.LENGTH_SHORT).show();
