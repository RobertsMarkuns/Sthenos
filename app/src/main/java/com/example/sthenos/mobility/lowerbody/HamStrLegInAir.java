...
import static com.example.sthenos.R.drawable.hamstring_oneleginair;

public class HamStrLegInAir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(hamstring_oneleginair);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Hamstring one leg in air stretch");
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HamStrLegInAir.this, Stopwatch.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(HamStrLegInAir.this, IndoorActivity.class);
                        Toast.makeText(HamStrLegInAir.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(HamStrLegInAir.this, OutdoorActivity.class);
                        Toast.makeText(HamStrLegInAir.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(HamStrLegInAir.this, MainActivity.class);
                        Toast.makeText(HamStrLegInAir.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(HamStrLegInAir.this, MobilityActivity.class);
                        Toast.makeText(HamStrLegInAir.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(HamStrLegInAir.this, Equipment.class);
                        Toast.makeText(HamStrLegInAir.this, item.getTitle(), Toast.LENGTH_SHORT).show();
