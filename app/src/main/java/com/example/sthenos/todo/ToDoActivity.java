...
import com.example.sthenos.todo.AlertReceiverToDoList;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(ToDoActivity.this, IndoorActivity.class);
                        Toast.makeText(ToDoActivity.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(ToDoActivity.this, OutdoorActivity.class);
                        Toast.makeText(ToDoActivity.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(ToDoActivity.this, MobilityActivity.class);
                        Toast.makeText(ToDoActivity.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(ToDoActivity.this, Equipment.class);
                        Toast.makeText(ToDoActivity.this, item.getTitle(), Toast.LENGTH_SHORT).show();
